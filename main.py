...
def help():
    ...
    stdout.write("             "+Fore.LIGHTRED_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"exit     "+Fore.LIGHTRED_EX+"|"+Fore.LIGHTWHITE_EX+" Exit YuaVN DDoS                        "+Fore.LIGHTRED_EX+"║\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"╠═════════════════════════════════════════════════════╣\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"THANK    "+Fore.LIGHTRED_EX+"|"+Fore.LIGHTWHITE_EX+" Thanks for using YuaMMB.               "+Fore.LIGHTRED_EX+"║\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"YOU♥     "+Fore.LIGHTRED_EX+"|"+Fore.LIGHTWHITE_EX+" Plz dont share this fuck lol           "+Fore.LIGHTRED_EX+"║\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"╚═════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
##############################################################################################
def credit():
...
def title():
    ...
    stdout.write("             "+Fore.LIGHTRED_EX            +"        ══╦═════════════════════════════════╦══\n")
    stdout.write("             "+Fore.LIGHTRED_EX+"╔═════════╩═════════════════════════════════╩═════════╗\n")
    stdout.write("             "+Fore.LIGHTRED_EX+"║ "+Fore.LIGHTWHITE_EX   +"        Welcome To The Main Screen Of YUADDOS  "+Fore.LIGHTRED_EX  +"     ║\n")
    stdout.write("             "+Fore.LIGHTRED_EX+"║ "+Fore.LIGHTWHITE_EX   +"          Type [help] to see the Commands    "+Fore.LIGHTRED_EX +"       ║\n")
    stdout.write("             "+Fore.LIGHTRED_EX+"║ "+Fore.LIGHTWHITE_EX   +"         Contact Dev - YuaVN#8086   "+Fore.LIGHTRED_EX +"                ║\n")
    stdout.write("             "+Fore.LIGHTRED_EX+"╚═════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
##############################################################################################
def command():
    stdout.write(Fore.LIGHTRED_EX+"╔═══"+Fore.LIGHTRED_EX+"[""root"+Fore.LIGHTGREEN_EX+"@"+Fore.LIGHTRED_EX+"YuaMMB"+Fore.CYAN+"]"+Fore.LIGHTRED_EX+"\n╚══\x1b[38;2;0;255;189m> "+Fore.WHITE)
    command = input()
...
##############################################################################################     
        ...
        stdout.write(Fore.MAGENTA+" [>] "+Fore.WHITE+"IP "+Fore.LIGHTRED_EX+": "+Fore.LIGHTGREEN_EX)
        target = input()
        try:
        ...
        stdout.write(Fore.MAGENTA+" [>] "+Fore.WHITE+"IP/DOMAIN "+Fore.LIGHTRED_EX+": "+Fore.LIGHTGREEN_EX)
        target = input()
        try:
